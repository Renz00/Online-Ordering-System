    ...
    <div data-app>
        <v-container>
             <v-alert
                v-model="alert"
                class="mx-4 my-2"
                v-if="this.getOrderResponse() === 'stored'"
                border="left"
            ...
            >
               ...
               <v-alert
                v-model="alert"
                class="mx-4 my-2"
                v-if="this.getOrderResponse() === 'deleted'"
                border="left"
                close-text="Close Alert"
                type="success"
            ...
            <h3 class="mt-2">
                <v-icon color="red">mdi-food-variant</v-icon>
                Orders</h3>
            <v-card class="mt-2">
                <span v-if="empty">No orders found...</span>
                <v-data-table
                    class="my-5"
                    loading
...
export default {
    ...
    data: () => ({
        ...
        alert: true,
        headers: [
            { text: "Order Ref", align: "start", value: "id" },
            { text: "Created By", value: "first_name" },
